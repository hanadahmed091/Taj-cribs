...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    areaSlug: 'chelsea',
    description:
      'A riverside apartment in Chelsea under our property management service. Currently let to a corporate tenant on a 3 year contract.',
    bedrooms: '2-bed apartment',
    service: 'short-let-management',
    monthlyIncome: '£4,000/month',
    highlight: 'Corporate tenant. 3 year let.',
